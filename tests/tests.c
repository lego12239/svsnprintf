...
test7_0_1(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 100, "some%fword", 33.0);
	if (ret != 17)
		TERR("ret must be 17 instead of %d", ret);
	if (strcmp(buf, "some33.000000word") != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 18; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
test7_0_2(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 1, "a%f", 33.0);
	if (ret != 10)
		TERR("ret must be 10 instead of %d", ret);
	if (memcmp(buf, "\0\x01", 2) != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 1; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
test7_0_3(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 2, "a%f", 33.0);
	if (ret != 10)
		TERR("ret must be 10 instead of %d", ret);
	if (memcmp(buf, "a\0", 2) != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 2; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
test7_0_7(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 6, "a%f", 33.0);
	if (ret != 10)
		TERR("ret must be 10 instead of %d", ret);
	if (strcmp(buf, "a33.0") != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 6; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
test7_3_1(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 100, "some%.2fword", 33.0);
	if (ret != 13)
		TERR("ret must be 13 instead of %d", ret);
	if (strcmp(buf, "some33.00word") != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 14; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
test7_14(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 100, "some%fword", 0.1234);
	if (ret != 16)
		TERR("ret must be 16 instead of %d", ret);
	if (strcmp(buf, "some0.123400word") != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 17; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
test7_14_1(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 100, "some%.0fword", 9.9999);
	if (ret != 10)
		TERR("ret must be 10 instead of %d", ret);
	if (strcmp(buf, "some10word") != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 11; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
test7_14_2(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 100, "some%.1fword", 9.9999);
	if (ret != 12)
		TERR("ret must be 12 instead of %d", ret);
	if (strcmp(buf, "some10.0word") != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 13; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
test7_14_3(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 100, "some%.2fword", 9.9999);
	if (ret != 13)
		TERR("ret must be 13 instead of %d", ret);
	if (strcmp(buf, "some10.00word") != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 14; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
test7_14_4(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 100, "some%.0fword", 0.9999);
	if (ret != 9)
		TERR("ret must be 9 instead of %d", ret);
	if (strcmp(buf, "some1word") != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 10; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
test14_0(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 100, "some%05.3dword", 1);
	if (ret != 13)
		TERR("ret must be 13 instead of %d", ret);
	if (strcmp(buf, "some  001word") != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 14; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
test14_2(void)
{
	...
	for(i = 0; i < 1024; i++)
		buf[i] = 1;
	ret = ssnprintf(buf, 100, "some%05.3dword", 123);
	if (ret != 13)
		TERR("ret must be 13 instead of %d", ret);
	if (strcmp(buf, "some  123word") != 0)
		TERR("result is wrong: '%s'", buf);
	for(i = 14; i < 1024; i++)
		if (buf[i] != 1)
			TERR("buf[%d] is %d", i, buf[i]);
...
struct test tests[] = {
	...
	{test2_32_1, "svsnprintf() with %*.*d (<0)"},
	{test2_32_2, "svsnprintf() with %*.*d (<0)"},
	{test2_32_3, "svsnprintf() with %*.*d (<0)"},
	...
	{test7_0_1, "svsnprintf() with %f (33.0)"},
	{test7_0_2, "svsnprintf() with %f (buf too small)"},
	{test7_0_3, "svsnprintf() with %f (buf too small, 2)"},
	{test7_0_4, "svsnprintf() with %f (buf too small, 3)"},
	...
	{test7_3_1, "svsnprintf() with %.2f (33.0)"},
	...
	{test7_13_1, "svsnprintf() with %*.*f(<0)"},
	{test7_13_2, "svsnprintf() with %*.*f(<0)"},
	{test7_13_3, "svsnprintf() with %*.*f(<0)"},
	{test7_14, "svsnprintf() with %f(0.1234)"},
	{test7_14_1, "svsnprintf() with %.0f(9.9999)"},
	{test7_14_2, "svsnprintf() with %.1f(9.9999)"},
	{test7_14_3, "svsnprintf() with %.2f(9.9999)"},
	{test7_14_4, "svsnprintf() with %.0f(0.9999)"},
	...
	{test9_9_1, "svsnprintf() with %*.*s(<0)"},
	{test9_9_2, "svsnprintf() with %*.*s(<0)"},
	{test9_9_3, "svsnprintf() with %*.*s(<0)"},
	...
	{test14_0, "svsnprintf() with %05.3d, 1"},
	{test14_1, "svsnprintf() with %+05.3d, 1"},
	{test14_2, "svsnprintf() with %05.3d, 123"},
	{test14_3, "svsnprintf() with %+05.3d, 123"},
	TEST_NULL
};
